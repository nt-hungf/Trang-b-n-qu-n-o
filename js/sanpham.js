...
function themDemo() {
  ...
  let sp3 = new Product(
    ...
    "Sp3.jpeg",
    "SẢN PHẨM Uniqlo",
    "Cotton Modal Open Collar Short Sleeve Shirt (Printed)",
    195000
  ); // Tạo các đối tượng cho lớp Product
  let sp4 = new Product(
    4,
  ...
  let sp6 = new Product(
    ...
    "Sp6.jpeg",
    "SẢN PHẨM Uniqlo",
    "Cotton Linen Open Collar Short Sleeve Shirt",
    588000
  ); // Tạo các đối tượng cho lớp Product
  let sp7 = new Product(
    7,
  ...
  let sp8 = new Product(
    ...
    "Sp8.jpeg",
    "SẢN PHẨM Uniqlo",
    "Áo Thun Judo t-shirt Bản Mới, Áo Phông Vải Cotton 100%. ",
    259000
  );
  // Tạo các đối tượng cho lớp Product
